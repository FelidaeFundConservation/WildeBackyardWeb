...
AUTHENTICATION_BACKENDS = [
    # Backend API authentication (primary)
...
MIDDLEWARE = [
    ...
    "siteapps.users.middleware.RefreshStaffFlagsMiddleware",
...
# BACKEND API
# ------------------------------------------------------------------------------
# Backend API URL for connecting to WildeBackyardBackend services
BACKEND_API_URL = env("BACKEND_API_URL", default="http://localhost:8000")
...
LOGGING = {
    ...
    "loggers": {
        "siteapps.users.auth_backend": {
            "handlers": ["console"],
            "level": "INFO",
        },
        "siteapps.users.api_client": {
            "handlers": ["console"],
            "level": "INFO",
        },
    },
